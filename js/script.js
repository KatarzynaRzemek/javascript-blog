...
function generateTags(){
  ...
  for(let article of articles){
    ...
    for(let tag of articleTagsArray){
      ...
      /* [NEW] check if this links in NOT already in allTags */
...
function generateAuthors(){
  ...
  for(let article of articles){
    ...
    /* generate HTML of the link */
    const linkHTML = 'by <a href="#author-' + articleAuthor.replace(' ', '-') + '">' + articleAuthor + '</a>';
  ...
  /* [NEW] create variable dor all links HTML code */
  let allAuthorsHTML = '';
  ...
  /* [NEW] add html form allAuthorsHTML to authorsList */
...
function authorClickHandler(event){
  ...
  /* make new constant named "clickedElement" and give it to the value of "this" */
  const clickedElement = this;

  /* make a new constant "href" and read the attribute of the clicked element */
  const href = clickedElement.getAttribute('href');

  /*make a new constant "author" and ectract from 'href" constant */
  ...
  /* execute function "generateTitleLinks" with article selector as argument */
  generateTitleLinks('[data-author="' + author.replace('-', ' ') + '"]');
}
